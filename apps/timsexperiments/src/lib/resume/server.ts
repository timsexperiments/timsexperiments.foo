...
export function createResumeServer() {
  ...
  server.registerTool('get_experience', {
    description: 'Read a complete experience story with personal contributions, outcomes, evidence qualifications, and an MCP resource URI. Use an ID returned by search_experience or get_resume.',
  ...
  server.registerTool('get_answer_brief', {
    description: 'Prepare a confident, evidence-led answer to a hiring question. Returns a suggested opening, complete supporting stories, MCP resource URIs, and relevant claim context. Include the previous topic when asking a conversational follow-up. The client writes the final answer.',
